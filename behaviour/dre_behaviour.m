...
for s = 1:length(subs)
    ...
    plotTight = 7;
    figure(plotVal)
    subplot(5,plotTight*5,1+plotTight*(s-1):3+plotTight*(s-1)),histogram(val_F(s,:),20,'facecolor',hist_fire_color)
    ...
    subplot(5,plotTight*5,4+plotTight*(s-1):6+plotTight*(s-1)),histogram(val_B(s,:),20,'facecolor',hist_boat_color)
