...
%         pl_B_66 = prctile(Y_B,75);
        ...
        for k = 1:nSweeps
            ...
            c_F = cvpartition(Y_F_logic,'holdOut',fracHoldOut);
            c_B = cvpartition(Y_B_logic,'holdOut',fracHoldOut);
            ...
            yTrain_F = double(Y_F_logic(idxTrain_F));
            
            % train B
            XTrain_B = X_B_red(idxTrain_B,:);
            yTrain_B = double(Y_B_logic(idxTrain_B));
