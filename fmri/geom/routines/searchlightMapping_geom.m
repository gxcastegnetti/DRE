function rs = searchlightMapping_geom(fullBrainVolumes, models, mask, userOptions, localOptions)
...
for cMappingVoxI = 1:nVox_mappingMask_request
    ...
    searchlightRDM_s1s2 = corr(t_s1(:,cIllValidVox_YspaceINDs)', t_s2(:,cIllValidVox_YspaceINDs)');   
    searchlightRDM_s1s3 = corr(t_s1(:,cIllValidVox_YspaceINDs)', t_s3(:,cIllValidVox_YspaceINDs)');   
