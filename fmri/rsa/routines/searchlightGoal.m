function [smm_rs, smm_ps, n, searchlightRDMs] = searchlightGoal(fullBrainVolumes, mask, userOptions, localOptions)
...
%     t_pats=t_pats(:,inputDataMask(:));
    error('There is more data than mask')
end
...
smm_ps=nan(volSize_vox);
smm_rs=nan(volSize_vox);
