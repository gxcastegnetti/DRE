function spmMat_name = dre_L1_rfx_iV_cS(dir,analysisName,subs,timing,bData)
...
for s = 1:length(subs)
    ...
    for r = 1:n_sess
        ...
        %% imagination
        job1LM{1}.spm.stats.fmri_spec.sess(r).cond(1).name = 'imagination';
        ...
        %% choice
        job1LM{1}.spm.stats.fmri_spec.sess(r).cond(2).name = 'choice';
