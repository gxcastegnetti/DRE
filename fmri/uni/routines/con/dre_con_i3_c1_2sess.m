function dre_con_i3_c1_2sess(dir,anName,subs)
...
for s = 1:length(subs)
    ...
    job{1}.spm.stats.con.consess{1}.tcon.weights = [1 0 0 0 0 0 movNull 1 0 0 0 0 0 movNull];
    ...
    job{1}.spm.stats.con.consess{2}.tcon.weights = [0 1 0 0 0 0 movNull 0 1 0 0 0 0 movNull];
    ...
    job{1}.spm.stats.con.consess{3}.tcon.weights = [0 0 1 0 0 0 movNull 0 0 1 0 0 0 movNull];
    ...
    job{1}.spm.stats.con.consess{4}.tcon.weights = [0 0 0 1 0 0 movNull 0 0 0 1 0 0 movNull];
    ...
    job{1}.spm.stats.con.consess{5}.tcon.weights = [0 0 0 0 1 0 movNull 0 0 0 0 1 0 movNull];
    job{1}.spm.stats.con.consess{5}.tcon.sessrep = 'none';
    
    % first parametric modulator
    job{1}.spm.stats.con.consess{6}.tcon.name = 'choice_1';
    job{1}.spm.stats.con.consess{6}.tcon.weights = [0 0 0 0 0 1 movNull 0 0 0 0 0 1 movNull];
