function dre_con_i3_c2(dir,anName,subs,taskOrd,context)
...
for s = 1:length(subs)
    ...
    job{1}.spm.stats.con.consess{1}.tcon.weights = [wS(1) 0 0 0 0 0 0 movNull wS(2) 0 0 0 0 0 0 movNull wS(3) 0 0 0 0 0 0 movNull wS(4) 0 0 0 0 0 0 movNull];
    job{1}.spm.stats.con.consess{1}.tcon.sessrep = 'none';
    
    job{1}.spm.stats.con.consess{2}.tcon.name = 'value';
    job{1}.spm.stats.con.consess{2}.tcon.weights = [0 wS(1) 0 0 0 0 0 movNull 0 wS(2) 0 0 0 0 0 movNull 0 wS(3) 0 0 0 0 0 movNull 0 wS(4) 0 0 0 0 0 movNull];
    job{1}.spm.stats.con.consess{2}.tcon.sessrep = 'none';
    
    job{1}.spm.stats.con.consess{3}.tcon.name = 'confidence';
    job{1}.spm.stats.con.consess{3}.tcon.weights = [0 0 wS(1) 0 0 0 0 movNull 0 0 wS(2) 0 0 0 0 movNull 0 0 wS(3) 0 0 0 0 movNull 0 0 wS(4) 0 0 0 0 movNull];
    job{1}.spm.stats.con.consess{3}.tcon.sessrep = 'none';
    
    job{1}.spm.stats.con.consess{4}.tcon.name = 'price';
    job{1}.spm.stats.con.consess{4}.tcon.weights = [0 0 0 wS(1) 0 0 0 movNull 0 0 0 wS(2) 0 0 0 movNull 0 0 0 wS(3) 0 0 0 movNull 0 0 0 wS(4) 0 0 0 movNull];
    ...
    job{1}.spm.stats.con.consess{5}.tcon.weights = [0 0 0 0 wS(1) 0 0 movNull 0 0 0 0 wS(2) 0 0 movNull 0 0 0 0 wS(3) 0 0 movNull 0 0 0 0 wS(4) 0 0 movNull];
    job{1}.spm.stats.con.consess{5}.tcon.sessrep = 'none';
    
    job{1}.spm.stats.con.consess{6}.tcon.name = 'chosen-unchosen CONGRUENT';
    job{1}.spm.stats.con.consess{6}.tcon.weights = [0 0 0 0 0 wS(1) 0 movNull 0 0 0 0 0 wS(2) 0 movNull 0 0 0 0 0 wS(3) 0 movNull 0 0 0 0 0 wS(4) 0 movNull];
    job{1}.spm.stats.con.consess{6}.tcon.sessrep = 'none';
    
    job{1}.spm.stats.con.consess{7}.tcon.name = 'chosen-unchosen INCONGRUENT';
    job{1}.spm.stats.con.consess{7}.tcon.weights = [0 0 0 0 0 0 wS(1) movNull 0 0 0 0 0 0 wS(2) movNull 0 0 0 0 0 0 wS(3) movNull 0 0 0 0 0 0 wS(4) movNull];
    job{1}.spm.stats.con.consess{7}.tcon.sessrep = 'none';
    
    job{1}.spm.stats.con.consess{8}.tcon.name = 'chosen-unchosen (CONGRUENT-INCONGRUENT)';
    job{1}.spm.stats.con.consess{8}.tcon.weights = [0 0 0 0 0 1 -1 movNull 0 0 0 0 0 1 -1 movNull 0 0 0 0 0 1 -1 movNull 0 0 0 0 0 1 -1 movNull];
