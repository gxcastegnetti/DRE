function dre_con_i3_c3(dir,anName,subs,taskOrd,context)
...
for s = 1:length(subs)
    ...
    job{1}.spm.stats.con.consess{9}.tcon.name = 'chosen-unchosen (CONGRUENT-INCONGRUENT)';
    job{1}.spm.stats.con.consess{9}.tcon.weights = [0 0 0 0 0 1 -1 0 movNull 0 0 0 0 0 1 -1 0 movNull 0 0 0 0 0 1 -1 0 movNull 0 0 0 0 0 1 -1 0 movNull];
