function dre_con_o1(dir,anName,subs)
...
for s = 1:length(subs)
    ...
    % onset 
    job{1}.spm.stats.con.consess{1}.tcon.name = 'onset';
    job{1}.spm.stats.con.consess{1}.tcon.weights = [1 0 movNull 1 0 movNull 1 0 movNull 1 0 movNull];
    job{1}.spm.stats.con.consess{1}.tcon.sessrep = 'none';
    
    % first parametric modulator
    job{1}.spm.stats.con.consess{2}.tcon.name = 'pmod1';
    job{1}.spm.stats.con.consess{2}.tcon.weights = [0 1 movNull 0 1 movNull 0 1 movNull 0 1 movNull];
